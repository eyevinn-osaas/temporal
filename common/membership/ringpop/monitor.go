...
var (
	...
	serviceNameToServiceTypeEnumMu  sync.RWMutex
)

func RegisterServiceNameToServiceTypeEnum(serviceName primitives.ServiceName, serviceType persistence.ServiceType) {
	serviceNameToServiceTypeEnumMu.Lock()
	defer serviceNameToServiceTypeEnumMu.Unlock()
...
func serviceNameToServiceTypeEnum(name primitives.ServiceName) (persistence.ServiceType, error) {
	serviceNameToServiceTypeEnumMu.RLock()
	defer serviceNameToServiceTypeEnumMu.RUnlock()
